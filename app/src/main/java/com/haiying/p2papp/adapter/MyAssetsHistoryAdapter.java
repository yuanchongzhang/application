...
public class MyAssetsHistoryAdapter extends RecyclerView.Adapter<MyAssetsHistoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tv05.setText(loglist.get(position).affect_money+"元");
        holder.tv06.setText(loglist.get(position).account_money+"元");
        holder.tv07.setText(loglist.get(position).freeze_money+"元");
        holder.tv08.setText(loglist.get(position).collect_money+"元");
